...
export const metadata: Metadata = {
  title: "SaaSify - Modern SaaS Platform for Teams",
  description: "Build, scale, and manage your SaaS product with confidence. All-in-one platform with real-time collaboration, advanced analytics, and enterprise security.",
  keywords: "SaaS platform, team collaboration, cloud management, analytics dashboard, developer tools",
  metadataBase: new URL("https://saasify.com"),
  alternates: {
    canonical: "https://saasify.com"
  },
  openGraph: {
    title: "SaaSify - Modern SaaS Platform",
    description: "All-in-one platform for building and scaling your SaaS product. Start free today.",
    type: "website",
    siteName: "SaaSify",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763807017062-cfqpyhr9.jpg",
        alt: "SaaSify Platform"
      }
    ]
  },
  twitter: {
    ...
    title: "SaaSify - Modern SaaS Platform",
    description: "Build, scale, and manage your SaaS product with confidence.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763807017062-cfqpyhr9.jpg"]
  },
  robots: {
    index: true,
    follow: true
